...
public class AdminInfo extends javax.swing.JFrame {
    ...
    public AdminInfo() {
        ...
        af.setAdminInfo(lblNumber, lblName, lblUsername, lblEmailInfo, 
                lblBirth);
        
        if (lblNumber.getText().equals("Admin123")) {
    ...
    private void btnChangePassActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChangePassActionPerformed
        this.dispose();
        new ChangeAdminPassword(lblUsername.getText()).setVisible(true);
